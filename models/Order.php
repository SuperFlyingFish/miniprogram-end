...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'user_id', 'is_pay', 'pay_type', 'pay_time', 'is_send', 'send_time', 'is_confirm', 'confirm_time', 'is_comment', 'apply_delete', 'addtime', 'is_delete', 'is_price', 'parent_id', 'is_offline', 'clerk_id', 'is_cancel', 'shop_id', 'user_coupon_id', 'give_integral', 'parent_id_1', 'parent_id_2', 'is_sale', 'mch_id', 'is_recycle', 'order_union_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pay_type' => '支付方式：0--在线支付未支付 1=微信支付 2--货到付款 3--余额支付',
            'pay_time' => '支付时间',

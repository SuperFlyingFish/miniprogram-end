...
class PtPrintForm extends Model
{
    public $order_id;
    public $store_id;
    public $express;
    ...
    public function send()
    {
        ...
        $express_exit = OrderExpress::findOne(['store_id'=>$this->store_id,'EBusinessID'=>$store->kdniao_mch_id,'order_id'=>$order->id,'order_type'=>2,'express_code'=>$express->code]);
        if($express_exit){
            $result = [

...
<!--                    <a flex="cross:center" class="head-step" href="#step8">会员折扣</a>-->
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label required">成本价</label>
                        </div>
                        <div class="col-9">
                            <div class="input-group short-row">
                                <input type="number" step="0.01" class="form-control"
                    ...
                    <div class="form-group row share-commission">
                        ...
                        <div class="col-9">
                            <div class="short-row">
                                ...
                                <div class="fs-sm text-danger">注：分销返利独立于三级佣金之外</div>
                                <div class="fs-sm text-danger">例如：分销返利是返给分销商自身，三级佣金是发给下单用户的推荐人</div>
                                <div class="input-group mb-3">
                ...
                <div>
                    <div class="form-group row">
                        <div class="form-group-label col-sm-2 text-right">
                            <label class="col-form-label">是否参与会员折扣</label>
                        </div>
                        <div class="col-sm-6">
                            <label class="radio-label">
                                <input id="radio1"
                                       value="0"
                                       name="model[member_discount]" type="radio" class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">参与</span>
                            </label>
                            <label class="radio-label">
                                <input id="radio2"
                                       value="1"
                                       name="model[member_discount]" type="radio" class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">不参与</span>
                            </label>
                        </div>
                    </div>
                </div>

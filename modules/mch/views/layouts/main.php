    ...
    <div class="main-header">
        ...
        <script>
            ...
            function playSound(id) {
                ...
                $.ajax({
                    url: "<?=$urlManager->createUrl(['mch/get-data/sound'])?>",
                    type: 'get',
                    dataType: 'json',
                    data: {
                        id: id
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.code == 0) {
                            ...
                            $('.message-list').append("<a class='dropdown-item' style='text-align:center' href='<?=Yii::$app->urlManager->createUrl(['mch/order/refund', 'status' => 1])?>'>全部消息</a>");
                        }
                    }
                });
            }

...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <form method="get" style="margin: -.3rem 0" class="float-right form-inline d-inline-block">
            ...
            <?php foreach ($get as $name => $value):if (!in_array($name, ['cat_id', 'keyword',])): ?>
                ...
                <?php foreach ($list as $i => $item): ?>
                    <tr>
                        ...
                        <td>
                            <label class="switch-label" style="line-height: inherit">
                                <input data-id="<?= $item->id ?>"
                                       type="checkbox" <?= $item->status == 1 ? 'checked' : '' ?>
                                       class="goods-status-switch">
                        ...
                        <td>
                            ...
                            <span>|</span>
                            <a href="<?= Yii::$app->urlManager->createUrl(['user/mch/goods/delete', 'id' => $item->id,]) ?>">删除</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
